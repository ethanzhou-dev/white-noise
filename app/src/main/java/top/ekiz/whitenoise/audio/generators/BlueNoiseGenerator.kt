...
class BlueNoiseGenerator : NoiseGenerator() {
    private var b0BlueL = 0.0
    private var b1BlueL = 0.0
    private var b2BlueL = 0.0
    private var b3BlueL = 0.0
    private var b4BlueL = 0.0
    private var b5BlueL = 0.0
    private var b6BlueL = 0.0
    private var lastBluePinkL = 0.0

    private var b0BlueR = 0.0
    private var b1BlueR = 0.0
    private var b2BlueR = 0.0
    private var b3BlueR = 0.0
    private var b4BlueR = 0.0
    private var b5BlueR = 0.0
    private var b6BlueR = 0.0
    ...
    override fun process(whiteL: Float, whiteR: Float) {
        ...
        val pinkL =
            b0BlueL + b1BlueL + b2BlueL + b3BlueL + b4BlueL + b5BlueL + b6BlueL + wL * 0.5362
        b6BlueL = wL * 0.115926
        ...
        val pinkR =
            b0BlueR + b1BlueR + b2BlueR + b3BlueR + b4BlueR + b5BlueR + b6BlueR + wR * 0.5362
        b6BlueR = wR * 0.115926
