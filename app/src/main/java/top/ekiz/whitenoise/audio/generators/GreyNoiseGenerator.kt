...
class GreyNoiseGenerator : NoiseGenerator() {
    private var greyLx1L = 0.0
    private var greyLx2L = 0.0
    private var greyLy1L = 0.0
    private var greyLy2L = 0.0
    private var greyHx1L = 0.0
    private var greyHx2L = 0.0
    private var greyHy1L = 0.0
    private var greyHy2L = 0.0

    private var greyLx1R = 0.0
    private var greyLx2R = 0.0
    private var greyLy1R = 0.0
    private var greyLy2R = 0.0
    private var greyHx1R = 0.0
    private var greyHx2R = 0.0
    private var greyHy1R = 0.0
    private var greyHy2R = 0.0

    private var greyL_b0 = 1.02268
    private var greyL_b1 = -1.96607
    private var greyL_b2 = 0.94636
    private var greyL_a1 = -1.96728
    private var greyL_a2 = 0.96781
    private var greyH_b0 = 1.78054
    private var greyH_b1 = -1.33301
    private var greyH_b2 = 0.48501
    private var greyH_a1 = -0.25003
    private var greyH_a2 = 0.18257
    ...
    override fun process(whiteL: Float, whiteR: Float) {
        ...
        val midL =
            greyL_b0 * wL + greyL_b1 * greyLx1L + greyL_b2 * greyLx2L -
                greyL_a1 * greyLy1L -
                greyL_a2 * greyLy2L
        greyLx2L = greyLx1L
        greyLx1L = wL
        ...
        val outY_L =
            greyH_b0 * midL + greyH_b1 * greyHx1L + greyH_b2 * greyHx2L -
                greyH_a1 * greyHy1L -
                greyH_a2 * greyHy2L
        greyHx2L = greyHx1L
        greyHx1L = midL
        ...
        val midR =
            greyL_b0 * wR + greyL_b1 * greyLx1R + greyL_b2 * greyLx2R -
                greyL_a1 * greyLy1R -
                greyL_a2 * greyLy2R
        greyLx2R = greyLx1R
        greyLx1R = wR
        ...
        val outY_R =
            greyH_b0 * midR + greyH_b1 * greyHx1R + greyH_b2 * greyHx2R -
                greyH_a1 * greyHy1R -
                greyH_a2 * greyHy2R
        greyHx2R = greyHx1R
        greyHx1R = midR
